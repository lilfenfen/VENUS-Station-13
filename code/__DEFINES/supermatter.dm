...
#define DELIRIUM_CONSUMPTION_PP (ONE_ATMOSPHERE*0.02)
#define DELIRIUM_PRESSURE_SCALING (ONE_ATMOSPHERE*0.6)
#define DELIRIUM_GASMIX_SCALING (0.5)
#define DELIRIUM_POWER_GAIN 50

/// How much delirium increases SM waste multiplier (multiplies SM_WASTE_GAS contribution)
#define DELIRIUM_WASTE_MODIFIER 2.0
