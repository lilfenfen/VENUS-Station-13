...
export function Changelog() {
  ...
  const getData = async (date, attemptNumber = 1) => {
    ...
    if (attemptNumber > maxAttempts) {
      setData(`Failed to load data after ${maxAttempts} attempts`);
      return;
    }
    ...
    <Stack>
      ...
      <Stack.Item>
        <Dropdown
          autoScroll={false}
          options={dateChoices}
          onSelected={(value) => handleSelect(dateChoices.indexOf(value))}
  ...
  const header = (
    <Section>
      ...
      <p>
        ...
        Traditional Games 13, Baystation 12, /vg/station, NTstation, CDK Station
      ...
      <p>
        ...
        <a href="https://github.com/lilfenfen/Veilbreak-Frontier?tab=members">
          here
        </a>
  ...
  const footer = (
    <Section>
      ...
      <p>
        The TGS DMAPI API is licensed as a subproject under the MIT license. See
        the footer of{' '}
        <a
          href={
